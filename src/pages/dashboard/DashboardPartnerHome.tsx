...
export default function DashboardPartnerHome() {
  const { user } = useAuth();
  ...
  const resources = [
    {
      ...
      description: "Napisz lub zamów artykuł u dziennikarza",
      icon: FileEdit,
      href: "/dashboard/partner/sponsored-article",
    },
    {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Panel Partnera</h1>
