...
const categoriesWithSubs: Category[] = [{
  ...
  subcategories: [{
    ...
    subcategories: [{
      ...
      name: "Partie polityczne",
      slug: "partie"
    }]
  }, {
    name: "Wypadki i zdarzenia",
    slug: "wypadki"
  }, {
    name: "Pogoda",
    slug: "pogoda"
  ...
  subcategories: [{
    ...
    subcategories: [{
      ...
      name: "Liga Mistrzów",
      slug: "liga-mistrzow-siatka"
    }, {
      name: "Reprezentacja",
      slug: "reprezentacja-siatka"
    }]
  }, {
    name: "Tenis",
    slug: "tenis",
  ...
  subcategories: [{
    ...
    name: "Internet i social media",
    slug: "internet"
  }, {
    name: "Recenzje i testy",
    slug: "recenzje"
  }, {
    name: "Aplikacje",
    slug: "aplikacje"
  ...
  subcategories: [{
    ...
    name: "Związki i relacje",
    slug: "zwiazki"
  }, {
    name: "Dom i wnętrza",
    slug: "dom"
  }, {
    name: "Gotowanie i przepisy",
    slug: "gotowanie",
    subcategories: [{
      name: "Obiady",
      slug: "obiady"
  ...
  subcategories: [{
    ...
    slug: "zdrowie-dziecka"
  }, {
    name: "Naturalne metody",
    slug: "naturalne"
  }]
}, {
  name: "Nauka",
  ...
  subcategories: [{
    ...
    name: "Natura i przyroda",
    slug: "natura"
  }, {
    name: "Historia",
    slug: "historia"
  }, {
    name: "Odkrycia naukowe",
    slug: "odkrycia"
  }, {
    name: "Ekologia i klimat",
    slug: "ekologia"
  }, {
    name: "Archeologia",
    slug: "archeologia"
...
export function CategoryBar({
  ...
  return <div className="sticky top-16 z-40 bg-background/95 backdrop-blur-md border-b border-border/50">
      <div className="container relative">
        {/* Left Arrow */}
        {showLeftArrow && <button onClick={() => scroll("left")} className="absolute left-0 top-1/2 -translate-y-1/2 z-10 h-full px-2 bg-gradient-to-r from-background via-background to-transparent">
      ...
      }} className="flex items-center gap-1 overflow-x-auto scrollbar-hide py-2 px-8 bg-neutral-800">
        ...
        {/* Right Arrow */}
        {showRightArrow && <button onClick={() => scroll("right")} className="absolute right-0 top-1/2 -translate-y-1/2 z-10 h-full px-2 bg-gradient-to-l from-background via-background to-transparent">
      ...
      {currentExpandedCategory && currentExpandedCategory.subcategories.length > 0 && <div className="border-t border-border/50 bg-muted/30 animate-slide-down" onMouseEnter={() => {
      if (hoverTimeout) clearTimeout(hoverTimeout);
          ...
          <div className="container py-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
              ...
              <div className="flex flex-col gap-2">
                <button className={cn("px-4 py-2 rounded-lg text-sm font-bold transition-colors text-left", activeCategory === currentExpandedCategory.slug ? "bg-[hsl(209,90%,58%)] text-white" : "bg-background hover:bg-muted text-foreground border border-border")} onClick={() => handleSubcategoryClick(currentExpandedCategory.slug)}>
                  📌 Wszystko
                </button>
              </div>
            ...
            return <div key={sub.slug} className="flex flex-col gap-1.5">
                    {/* Main subcategory header */}
                    <button className={cn("px-3 py-1.5 rounded-md text-sm font-bold transition-colors text-left border-b-2 border-[hsl(209,90%,58%)]/30 pb-2 mb-1", isActive ? "text-[hsl(209,90%,58%)]" : "text-foreground hover:text-[hsl(209,90%,58%)]")} onClick={() => handleSubcategoryClick(currentExpandedCategory.slug, sub.slug)}>
                      {sub.name}
                    </button>
                    
                    {/* Sub-subcategories as vertical list */}
                    {hasSubSubs && <div className="flex flex-col gap-0.5">
                  ...
                  return <button key={subSub.slug} className={cn("px-3 py-1 rounded text-xs transition-colors text-left", isSubSubActive ? "bg-[hsl(209,90%,58%)]/10 text-[hsl(209,90%,58%)] font-medium" : "text-muted-foreground hover:text-foreground hover:bg-muted/50")} onClick={() => handleSubcategoryClick(currentExpandedCategory.slug, sub.slug, subSub.slug)}>
                              {subSub.name}
                            </button>;
                })}
                      </div>}
